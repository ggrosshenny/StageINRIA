...
def createScene(node):
    ...
    # Physic manager
    poutreNode.createObject('TetrahedronFEMForceField', name='FEM', youngModulus='100', poissonRatio='0.2', computeGlobalMatrix='false', drawAsEdges='true', drawHeterogeneousTetra='true')
    ...
    poutreNode.createObject('ConstantForceField', points='constForceFieldROI.indices', force='0.1 0 0', arrowSizeCoef='0.1')
